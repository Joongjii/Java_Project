...
public class _List {
	...
	public void studyList() {
				...
				// 1.8 이전에는 레퍼런스 타입(ArrayList)에도 제네릭 타입(Music)을 명시 해야 했으나
				// 1.8 이후로 부터 인스턴스화 하는 생성자(List)에만 명시해도 괜찮음
				//지네릭스 - 타입 체크
				// Music 객체만 저장할 수 있는 ArrayList를 생성
				// 순서가 있는 중복도 있는 배열 형식의 리스트
		...
		public static void main(String[] args) {
			...
			//2. list의 크기를 출력하세요.
					...
					//3. 2번 인덱스에 원하는 노래 인스턴스를 추가하세요.
					list.add(2, new Music("안예은", "문어의 꿈"));
					System.out.println("3. 2번 인덱스에 원하는 노래 "
							+ "인스턴스를 추가하세요. : \n" + list);
					System.out.println("------------------------------------------------");
					
					//4. list의 2번 인덱스에 저장된 값을 받아서 출력하세요.
					System.out.println("4. list의 2번 인덱스에 저장된 값을 "
							+ "받아서 출력하세요. : \n" + list.get(2));
					System.out.println("------------------------------------------------");
					...
					//수정은 get으로 한다
					list.set(2, new Music("윤하", "사건의 지평선"));
					System.out.println("5. 2번 인덱스에 담긴 데이터를 new Music"
							+ "(\"윤하\",\"사건의 지평선\") 로 수정하세요 : \n" + list.get(2));
					System.out.println("------------------------------------------------");
					...
					//7. list의 0~1번 인덱스 사이의 데이터를 잘라내어 새로운 List로 반환받아 출력하세요.
					//subList -- 0 <= X <1 (1은 포함되지 않는다)
					System.out.println("7. list의 0~1번 인덱스 사이의 데이터를 잘라내어"
							+ " 새로운 List로 반환받아 출력하세요. : \n" + list.subList(0, 1));
					...
					//   결과가 false 가 나온다면 true가 나오도록 코드를 수정해주세요.
					list.add(2, new Music("김광석", "서른즈음에"));
					System.out.println("8. 2번 인덱스에 new Music(\"김광석\",\"서른즈음에\")를"
							+ " 추가 하세요. : \n" + list);
					System.out.println("새롭게 추가한 new Music(\"김광석\",\"서른즈음에\") 이 list에"
							+ " 존재하는지 확인 : " + list.contains(new Music("김광석", "서른즈음에")));
					System.out.println("------------------------------------------------");
